        ...
        <div className="flex items-center justify-between h-16 gap-2">
          ...
          <div className="flex items-center gap-2.5 shrink-0">
            <div className="relative">
              <img
                src="/ishak_logo.png"
                alt="Ishak AI"
                className="w-9 h-9 sm:w-11 sm:h-11 rounded-full border-2 border-[#00E5FF] shadow-[0_0_15px_rgba(0,229,255,0.7),0_0_25px_rgba(0,229,255,0.35)] object-cover"
                referrerPolicy="no-referrer"
                onError={(e) => {
                  (e.target as HTMLElement).style.display = 'none';
                }}
              />
              <span className="absolute -bottom-0.5 -right-0.5 w-2.5 h-2.5 sm:w-3 sm:h-3 bg-emerald-400 border-2 border-[#0B132B] rounded-full animate-pulse" />
            </div>
            <div>
              <div className="flex items-center gap-1.5">
                <span className="text-white font-black text-sm sm:text-base tracking-wide flex items-center gap-1">
                  ISHAK AI <span className="text-cyan-300 text-[9px] sm:text-[10px] px-1.5 py-0.2 rounded bg-cyan-950/90 border border-cyan-400/40 font-black">VIP</span>
                </span>
              </div>
              <p className="text-[10px] text-gray-400 hidden lg:block">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
            <button
              ...
              className="p-2 sm:p-2 rounded-xl bg-slate-800/80 border border-slate-700/80 text-cyan-400 hover:bg-cyan-500/10 transition active:scale-95"
            >
            ...
            <button
              ...
              className="p-2 sm:px-2.5 sm:py-1.5 rounded-xl bg-slate-800/80 hover:bg-slate-700 border border-slate-700 text-gray-200 text-xs font-semibold flex items-center gap-1.5 transition active:scale-95"
            >
              <Lock className="w-4 h-4 sm:w-3.5 sm:h-3.5 text-cyan-400" />
            ...
            <button
              ...
              onClick={onLogout}
              title="লগআউট করুন"
              className="p-2 rounded-xl bg-rose-500/10 hover:bg-rose-500/20 border border-rose-500/30 text-rose-400 transition active:scale-95"
            >
